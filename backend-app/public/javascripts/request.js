...
const splitting_modal_popup = document.querySelector(
  ".request-main-body-splitting-option-btn"
);
const splitting_option_modal_popup = document.querySelector(
  ".request-splitting-options"
);
...
const span_request_main_body_splitting_option_btn = document.querySelector(
  ".request-main-body-splitting-option-btn"
);
const input_split_equally = document.querySelector(
  ".request-main-body-hero-form-cost"
);
const input_split_unequally = document.querySelector(
  ".request-split-by-amount-input"
);
const dismissal = document.querySelector(".dismisa1");

const description = document.querySelector(
  ".request-main-body-hero-form-description"
);
...
const container_group_messages = document.querySelector(
  ".container--group-messages"
);
container_group_messages.scrollTop =
  container_group_messages.scrollHeight - container_group_messages.clientHeight;

splitting_modal_popup.addEventListener("click", function () {
  const amount = +input_split_equally.value;
  const members = Array.from(
    document.querySelectorAll(".request-split-equally-amount")
  );
...
btn_split_equally.addEventListener("click", () => {
  ...
  if (!(description.value === "")) {
    ...
    const allEqualInputs = document.querySelectorAll(
      ".request-split-equally-amount"
    );
    console.log(allEqualInputs);
    const allUnequalInputs = document.querySelectorAll(
      ".request-split-by-amount-input"
    );
...
[input_split_equally, input_split_unequally].forEach((input) => {
